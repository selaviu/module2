...
**5.1. Використання готового файлу для імпорту**

Для тестування масового завантаження ви можете використати вже підготовлений файл jsonForUpload.json, який містить узгоджені з Liquibase UUID.

**Шлях до файлу в проєкті:**

    /module2/jsonForUpload.json

**5.2. Очікувана Структура JSON**
